	<div class="contenedor">
		...
		<div data-pushbar-id="pushbar-menu" class="pushbar" style="width: 100px;" data-pushbar-direction="left">
			...
			<nav>
				<a href=""><img style="width: 70px; margin-left:13%; "src="img/fotografo.png"></a>
				...
				<li><a href="#"><img style="width: 50px; margin-left:20%; "  src="img/configuraciones.png"></a></li></ul>
				<a href=""><img style="width: 50px; margin-left:20%; "src="img/entrar.png"></a>
			</nav>
		</div>
