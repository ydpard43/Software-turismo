  ...
  for (var j =0; j<re[1].length; j++) {
    ...
    if(re[0][i].vi==  re[1][j].vi){
      if (re[0][i].count==1) {
       ...
       content_ecu=content_ecu+re[0][i].vn+" ("+re[1][j].fn+" * <input type=\"number\" name=\"factor_variable[]\" style=\"width: 10%; margin-bottom: 1%; \" onchange=\"cambiar()\" value=\""+re[1][j].fp+"\">) ( Valor maximo <input type=\"number\" name=\"max_var[]\" style=\"width: 10%;\" onchange=\"cambiar()\" value=\""+re[0][i].vp+"\" > ) + ";
     ...
     content_ecu=content_ecu+re[0][i].vn+" ("+re[1][j].fn+" * <input type=\"number\" name=\"factor_variable[]\"  style=\"width: 10%; margin-bottom: 1%; \" onchange=\"cambiar()\" value=\""+re[1][j].fp+"\" >+ ";
     content=content+'<li>'+re[0][i].vn+' : '+re[0][i].vd+'</li>'+''+'<li>'+re[1][j].fn+' : '+re[1][j].fd+'</li>'+'';
     n=n-1;
   }else if(n==1){
    variables=variables+""+re[1][j].fn+" * "+re[1][j].fp+") ( Valor maximo "+re[0][i].vp+" ) + ";
    content_ecu=content_ecu+""+re[1][j].fn+" * <input type=\"number\" style=\"width: 10%;\" name=\"factor_variable[]\" onchange=\"cambiar()\" value=\""+re[1][j].fp+"\" > ) ( Valor maximo <input type=\"number\" name=\"max_var[]\" style=\"width: 10%; margin-bottom: 1%; \" onchange=\"cambiar()\" value=\""+re[0][i].vp+"\" >) + ";
     content=content+''+'<li>'+re[1][j].fn+' : '+re[1][j].fd+'</li>'+'';
   }
   else if(n!=1){
    variables=variables+""+re[1][j].fn+" * "+re[1][j].fp+" + ";
    content_ecu=content_ecu+""+re[1][j].fn+" * <input type=\"number\" style=\"width: 10%; margin-bottom: 1%;\" onchange=\"cambiar()\" value=\""+re[1][j].fp+"\"> + ";
    content=content+''+'<li>'+re[1][j].fn+' : '+re[1][j].fd+'</li>'+'';
    n=n-1;
   }
 }
...
for (var i =0; i<re.length; i++) {
  if (i!=re.length-1) {
     ...
     content_ecu=content_ecu+""+re[i]['nombre']+" * <input onchange=\"cambiar()\" name=\"factor[]\" style=\"width: 10%; margin-bottom: 10px;\" type=\"number\" value=\""+re[i]['peso']+"\"> +" +"<input style=\"width: 10%;\"  name=\"factor_max[]\" type=\"hidden\" value=\""+re[i]['fm']+"\">"+"<input name=\"f_i[]\" type=\"hidden\" value=\""+re[i]['id_factor']+"\">"+"";
   }else{
     content2=content2+(''+re[i]['nombre']+' * '+re[i]['peso']+' ');
     content_ecu=content_ecu+""+re[i]['nombre']+" * <input style=\"width: 10%; margin-bottom: 10px; \" name=\"factor[]\" onchange=\"cambiar()\" type=\"number\" value=\""+re[i]['peso']+"\">"+"<input style=\"width: 10%;\"  name=\"factor_max[]\" type=\"hidden\" value=\""+re[i]['fm']+"\">"+"<input name=\"f_i[]\" type=\"hidden\" value=\""+re[i]['id_factor']+"\">"+"";
   }
